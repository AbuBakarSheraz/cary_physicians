...
function HeroSection() {
  ...
  >
      <div className="h-full w-92 md:w-[520px] flex flex-col justify-center text-end mr-10 md:mr-30 lg:mr-50">
        <h1 
...
</div>    <p className='ml-2'>Please use messages for non-urgent communications only. If this is an emergency, please call 911.</p>
