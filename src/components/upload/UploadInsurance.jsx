...
const sendImagesToBackend = () => {
  ...
  fetch("https://www.caryphysicians.com/api/insurancecards/upload_id.php", {
    method: "POST",
    body: formData,
  })
    .then((res) => {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Insurance Card Upload</h1>
          ...
          {currentStep === "name" && (
            <div className="text-center">
              ...
              <div className="max-w-md mx-auto">
                ...
                >
                  Continue to Insurance Card Upload
                </button>
              </div>
            </div>
          )}
          ...
          {currentStep === "front" && (
            <div>
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Front Side of Your Insurance Card</h2>
                <p className="text-gray-600">Take a clear photo of the front of your Insurance Card or driver's license</p>
              </div>
              ...
              {(frontCaptured || frontUploaded) && (
                <div className="mb-6">
                  <p className="text-sm text-gray-600 mb-2 font-medium">Front of Insurance Card:</p>
                  <img 
